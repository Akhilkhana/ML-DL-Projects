...
df = pd.read_csv(
    r'C:\Users\akhil gunti\AGENTIC_AI\AI\MULTIPLE LANGUAGE TRANSLATION\language.csv')
...
if len(inputtext) > 0:
    try:
        ...
        if choice in speech_langs.values():
            with c2:
                aud_file = gTTS(
                    text=output, lang=lang_array[choice], slow=False)
                ...
                st.markdown(get_binary_file_downloader_html(
                    "lang.mp3", 'Audio File'), unsafe_allow_html=True)
