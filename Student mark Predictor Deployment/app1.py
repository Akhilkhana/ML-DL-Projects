...
app = Flask(__name__)
model = joblib.load(r"D:\Full stack Data Science with GenAI&Agentic\Recordings & Notes\Machine Learning\ML Project\Student mark Predictor Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
